...
<!------------------- Navigation bar ends ------------------------->
<div class="well">
  <center><h4> Parking monitors register here </h4></center>
</div>
<div class="container-fluid">
<div class="row">
  <div class="col-xs-8 col-xs-offset-2 col-md-4 col-md-offset-4">
  <form action="monitor_register_update.php" method="post" >
    ...
    <div class="form-group">
      <label for="ownid">Owner ID:</label>
      <input type="name" class="form-control" id="ownid" name="ownid">
    </div>
    <div class="form-group">
      <label for="phn">Phone:</label>
      <input type="name" class="form-control" id="phn" name="phn">
    </div>
    <div class="form-group">

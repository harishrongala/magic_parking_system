...
<head>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjMCVGz3TlmuKFuwQ-H7-ORIQQlZ6s2mA"
    async defer></script>
    <script src="geocoding_support.js"></script>
</head>
<body>
...
<div class="container" id="search_bar" >
  <div class="row">
<div class="col-xs-6 col-xs-offset-3 col-md-4 col-md-offset-4 input-group" id="search_col">

  <input type="text" class="form-control" placeholder="Search" id="search_text">

  <span class="input-group-btn" id="btn_span">

...
$uploaddir = 'C:\wamp64\www\pages\magic_parking_system\Phase2\image';
$uploadfile = $uploaddir .$_user_id. basename($_FILES['userfile']['name']);
move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadfile);
$picname=$_user_id. basename($_FILES['userfile']['name']);
$que="INSERT INTO parkingspaces (owner_id, lat, lon, address, maxduration, picture) VALUES ('$_user_id','$_loc_lat','$_loc_lng','$_loc_address','$_max','$picname')";

...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <ul class="nav navbar-nav navbar-right">
    <li><a href="owner_signup.php"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
    <li><a href="owner_signup.php"><span class="glyphicon glyphicon-login"></span> Login</a></li>
...
<div class="container-fluid">
<div class="row">
  <div class="col-sm-6 thumbnail col-md-6 col-md-offset-3">
    <img src="images/ownership_icon.png" class="img-circle" style="width: 30%;">

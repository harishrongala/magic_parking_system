...
if(isset($_SESSION['userid']))
{
  ...
  $que="SELECT fname FROM customer WHERE user_id='$user'";
...
<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.7.14/css/bootstrap-datetimepicker.min.css" rel="stylesheet"/>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjMCVGz3TlmuKFuwQ-H7-ORIQQlZ6s2mA"
    ...
    <script src="scripts/support_centerchanged_type2.js"></script>
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <ul class="nav navbar-nav navbar-right">
    <li><a href="myreservations.php"><span class="glyphicon glyphicon-file"></span> My Tickets</a></li>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-xs-2 col-xs-offset-4 col-md-2 col-md-offset-2">
            <img class="responsive" src="" id="parking_space_image" style="width:150px; height:100px;">
          </div>
        </div>
...
<div class="row">
  <div class="col-xs-12 col-md-6 col-lg-6 col-sm-8">
    <button class="btn btn-success pull-right" onclick="make_reservation()">Reserve</button>
  </div>
</div>
...
<div class="container-fluid">
  <div class="row">
<div class="alert alert-info " id="notify_here" style="width:100%"><center>Welcome <?php echo $_SESSION['name'];?><center> </div>
</div>
</div>
<!------- Message area ends----------->

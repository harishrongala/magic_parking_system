...
<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.7.14/css/bootstrap-datetimepicker.min.css" rel="stylesheet"/>
  <!--link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"-->
    <link rel="stylesheet" href="css_take_me_to_parking.css">
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjMCVGz3TlmuKFuwQ-H7-ORIQQlZ6s2mA"
    ...
    <script src="support_take_me_to_parking.js"></script>
...
<div class="col-xs-12 col-xs-offset-0 col-md-8 col-md-offset-2">
  ...
  <div class="input-group">
    <span class="input-group-addon"><span class="glyphicon glyphicon-thumbs-down"></span></span><select class="form-control" id="max_modal" name="com_reason">
      ...
      <option value="Can't find parking space here">Can't find parking space here</option>
...
$.post("get_space_details_from_ticketid.php",{tickid:ticketid},function(result){
